...
class GovernanceMiddleware:
    ...
    async def execute_governed_tool(
        user_id: str,
        user_role: str = "User",
        tool_name: str = "general_tool",
        tool_func: Callable = None,
        *args,
        **kwargs
    ) -> Dict[str, Any]:
        """Wrapper method intercepting tool calls for explainability and audit logging (unrestricted execution)."""
        logger.info(f"Governance Middleware executing tool: '{tool_name}' for User: '{user_id}'")
